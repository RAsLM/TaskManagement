...
@EntityScan(basePackages = {"com.rasl.pojo"}) //specifies the packages to look for JPA Entities.
@EnableJpaRepositories(basePackages = {"com.rasl.repositories"}) //enables the auto configuration of Spring Data JPA.
